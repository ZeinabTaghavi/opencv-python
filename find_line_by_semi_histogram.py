...
def find_line_by_semi_histogram(img_file):
    ...
    gray_corrected_rotation = cv2.cvtColor(corrected_rotation , cv2.COLOR_BGR2GRAY)
    ...
    cv2.imwrite('find_line_by_semi_histogram_2_vertical_line_rected.jpg',corrected_rotation)
    ...
    cv2.imwrite('find_line_by_semi_histogram_3_horizontal_line_rected.jpg', gray_corrected_rotation)
